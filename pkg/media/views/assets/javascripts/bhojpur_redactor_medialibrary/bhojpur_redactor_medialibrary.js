...
$R.add("plugin", "medialibrary", {
    ...
    funcInit: function(self) {
      ...
      this.addMedialibrary = function() {
        ...
        thisFunc.BottomSheets = BottomSheets = $("body").data("bhojpur.bottomsheets");
      ...
      this.handleMediaLibrary = function($bottomsheets) {
        ...
        $bottomsheets
          .bhojpurSelectCore(options)
          .addClass("bhojpur-bottomsheets__mediabox");
        thisFunc.initItem();
      };
  
      this.initItem = function() {
        var $trs = $(".bhojpur-bottomsheets").find("tbody tr"),
          $tr,
          $img;
        ...
        $trs.each(function() {
          ...
          if ($img.length) {
            $tr
              .find(".bhojpur-table--medialibrary-item")
      ...
      this.insertVideo = function(data) {
        ...
        var htmlCode,
          ...
          videoIdentification = "bhojpur-video-" + randomString,
          mediaOption = data.MediaOption,
