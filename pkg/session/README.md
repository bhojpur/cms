# Bhojpur CMS - Session Management

It wrapped other libs like [SCS](https://github.com/alexedwards/scs), [Gorilla Session](http://www.gorillatoolkit.org/pkg/sessions) into a common interface, which will be used for [Bhojpur CMS](https://github.com/bhojpur/cms) libraries and your application.
...
## Bhojpur CMS Integration

We have created a default session manager in package `github.com/bhojpur/cms/pkg/session/manager`, which is used in some [Bhojpur CMS](https://github.com/bhojpur/cms) libs like Admin, Auth by default to manage session, flash messages. It is defined like below:
