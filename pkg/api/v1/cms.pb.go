...
func (FilterOp) Descriptor() protoreflect.EnumDescriptor {
	return file_cms_proto_enumTypes[0].Descriptor()
}

func (FilterOp) Type() protoreflect.EnumType {
	return &file_cms_proto_enumTypes[0]
}
...
func (ListenRequestLogs) Descriptor() protoreflect.EnumDescriptor {
	return file_cms_proto_enumTypes[1].Descriptor()
}

func (ListenRequestLogs) Type() protoreflect.EnumType {
	return &file_cms_proto_enumTypes[1]
}
...
type PageTrigger int32

const (
	PageTrigger_TRIGGER_UNKNOWN PageTrigger = 0
	PageTrigger_TRIGGER_MANUAL  PageTrigger = 1
	PageTrigger_TRIGGER_PUSH    PageTrigger = 2
	PageTrigger_TRIGGER_DELETED PageTrigger = 3
)

// Enum value maps for PageTrigger.
var (
	PageTrigger_name = map[int32]string{
		0: "TRIGGER_UNKNOWN",
		1: "TRIGGER_MANUAL",
		2: "TRIGGER_PUSH",
		3: "TRIGGER_DELETED",
	}
	PageTrigger_value = map[string]int32{
		"TRIGGER_UNKNOWN": 0,
		"TRIGGER_MANUAL":  1,
		"TRIGGER_PUSH":    2,
		"TRIGGER_DELETED": 3,
...
func (x PageTrigger) Enum() *PageTrigger {
	p := new(PageTrigger)
	*p = x
	return p
}

func (x PageTrigger) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PageTrigger) Descriptor() protoreflect.EnumDescriptor {
	return file_cms_proto_enumTypes[2].Descriptor()
}

func (PageTrigger) Type() protoreflect.EnumType {
	return &file_cms_proto_enumTypes[2]
}

func (x PageTrigger) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PageTrigger.Descriptor instead.
func (PageTrigger) EnumDescriptor() ([]byte, []int) {
	return file_cms_proto_rawDescGZIP(), []int{2}
}

type PagePhase int32

const (
	// Unknown means we don't know what state the Page is in
	PagePhase_PHASE_UNKNOWN PagePhase = 0
	// Preparing means the Page hasn't started yet and isn't consuming resources in the system
	PagePhase_PHASE_PREPARING PagePhase = 1
	// Starting means the Page has been scheduled and is waiting to run. Things that might prevent it
	// from running already are pod scheduling, image pull or container startup.
	PagePhase_PHASE_STARTING PagePhase = 2
	// Running means the Page is actually running and doing work.
	PagePhase_PHASE_RUNNING PagePhase = 3
	// Done means the Page has run and is finished
	PagePhase_PHASE_DONE PagePhase = 4
	// Cleaning means the Page is in post-run cleanup
	PagePhase_PHASE_CLEANUP PagePhase = 5
	// Waiting means the Page is waiting for its start time or some other condition to be met
	PagePhase_PHASE_WAITING PagePhase = 6
)

// Enum value maps for PagePhase.
var (
	PagePhase_name = map[int32]string{
		0: "PHASE_UNKNOWN",
		1: "PHASE_PREPARING",
		2: "PHASE_STARTING",
		3: "PHASE_RUNNING",
	...
	PagePhase_value = map[string]int32{
		"PHASE_UNKNOWN":   0,
		"PHASE_PREPARING": 1,
		"PHASE_STARTING":  2,
		"PHASE_RUNNING":   3,
...
func (x PagePhase) Enum() *PagePhase {
	p := new(PagePhase)
	*p = x
	return p
}

func (x PagePhase) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PagePhase) Descriptor() protoreflect.EnumDescriptor {
	return file_cms_proto_enumTypes[3].Descriptor()
}

func (PagePhase) Type() protoreflect.EnumType {
	return &file_cms_proto_enumTypes[3]
}

func (x PagePhase) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PagePhase.Descriptor instead.
func (PagePhase) EnumDescriptor() ([]byte, []int) {
...
func (LogSliceType) Descriptor() protoreflect.EnumDescriptor {
	return file_cms_proto_enumTypes[4].Descriptor()
}

func (LogSliceType) Type() protoreflect.EnumType {
	return &file_cms_proto_enumTypes[4]
}
...
type StartLocalPageRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Content:
	//	*StartLocalPageRequest_Metadata
	//	*StartLocalPageRequest_ConfigYaml
	//	*StartLocalPageRequest_PageYaml
	//	*StartLocalPageRequest_ApplicationTar
	//	*StartLocalPageRequest_ApplicationTarDone
	Content isStartLocalPageRequest_Content `protobuf_oneof:"content"`
}

func (x *StartLocalPageRequest) Reset() {
	*x = StartLocalPageRequest{}
...
func (x *StartLocalPageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartLocalPageRequest) ProtoMessage() {}

func (x *StartLocalPageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cms_proto_msgTypes[0]
...
// Deprecated: Use StartLocalPageRequest.ProtoReflect.Descriptor instead.
func (*StartLocalPageRequest) Descriptor() ([]byte, []int) {
	return file_cms_proto_rawDescGZIP(), []int{0}
}

func (m *StartLocalPageRequest) GetContent() isStartLocalPageRequest_Content {
	if m != nil {
		return m.Content
	}
	return nil
...
func (x *StartLocalPageRequest) GetMetadata() *PageMetadata {
	if x, ok := x.GetContent().(*StartLocalPageRequest_Metadata); ok {
		return x.Metadata
	}
	return nil
}

func (x *StartLocalPageRequest) GetConfigYaml() []byte {
	if x, ok := x.GetContent().(*StartLocalPageRequest_ConfigYaml); ok {
		return x.ConfigYaml
	}
	return nil
}

func (x *StartLocalPageRequest) GetPageYaml() []byte {
	if x, ok := x.GetContent().(*StartLocalPageRequest_PageYaml); ok {
		return x.PageYaml
	}
	return nil
}

func (x *StartLocalPageRequest) GetApplicationTar() []byte {
	if x, ok := x.GetContent().(*StartLocalPageRequest_ApplicationTar); ok {
		return x.ApplicationTar
	}
	return nil
}

func (x *StartLocalPageRequest) GetApplicationTarDone() bool {
	if x, ok := x.GetContent().(*StartLocalPageRequest_ApplicationTarDone); ok {
		return x.ApplicationTarDone
	}
	return false
}

type isStartLocalPageRequest_Content interface {
	isStartLocalPageRequest_Content()
}

type StartLocalPageRequest_Metadata struct {
	Metadata *PageMetadata `protobuf:"bytes,1,opt,name=metadata,proto3,oneof"`
}

type StartLocalPageRequest_ConfigYaml struct {
	ConfigYaml []byte `protobuf:"bytes,2,opt,name=config_yaml,json=configYaml,proto3,oneof"`
}

type StartLocalPageRequest_PageYaml struct {
	PageYaml []byte `protobuf:"bytes,3,opt,name=page_yaml,json=pageYaml,proto3,oneof"`
}

type StartLocalPageRequest_ApplicationTar struct {
	ApplicationTar []byte `protobuf:"bytes,4,opt,name=application_tar,json=applicationTar,proto3,oneof"`
}

type StartLocalPageRequest_ApplicationTarDone struct {
	ApplicationTarDone bool `protobuf:"varint,5,opt,name=application_tar_done,json=applicationTarDone,proto3,oneof"`
}

func (*StartLocalPageRequest_Metadata) isStartLocalPageRequest_Content() {}

func (*StartLocalPageRequest_ConfigYaml) isStartLocalPageRequest_Content() {}

func (*StartLocalPageRequest_PageYaml) isStartLocalPageRequest_Content() {}

func (*StartLocalPageRequest_ApplicationTar) isStartLocalPageRequest_Content() {}

func (*StartLocalPageRequest_ApplicationTarDone) isStartLocalPageRequest_Content() {}
...
type StartPageResponse struct {
	...
	Status *PageStatus `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
}

func (x *StartPageResponse) Reset() {
	*x = StartPageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *StartPageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartPageResponse) ProtoMessage() {}

func (x *StartPageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cms_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartPageResponse.ProtoReflect.Descriptor instead.
func (*StartPageResponse) Descriptor() ([]byte, []int) {
	return file_cms_proto_rawDescGZIP(), []int{1}
}

func (x *StartPageResponse) GetStatus() *PageStatus {
	if x != nil {
		return x.Status
	}
	return nil
...
type StartPageRequest struct {
	...
	PagePath   string                 `protobuf:"bytes,2,opt,name=page_path,json=pagePath,proto3" json:"page_path,omitempty"`
	PageYaml   []byte                 `protobuf:"bytes,3,opt,name=page_yaml,json=pageYaml,proto3" json:"page_yaml,omitempty"`
...
func (x *StartPageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartPageRequest) ProtoMessage() {}

func (x *StartPageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cms_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartPageRequest.ProtoReflect.Descriptor instead.
func (*StartPageRequest) Descriptor() ([]byte, []int) {
	return file_cms_proto_rawDescGZIP(), []int{2}
}

func (x *StartPageRequest) GetMetadata() *PageMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *StartPageRequest) GetPagePath() string {
	if x != nil {
		return x.PagePath
	}
	return ""
...
func (x *StartPageRequest) GetPageYaml() []byte {
	if x != nil {
		return x.PageYaml
	}
	return nil
...
func (x *StartPageRequest) GetSideload() []byte {
	if x != nil {
		return x.Sideload
	}
	return nil
...
func (x *StartPageRequest) GetWaitUntil() *timestamppb.Timestamp {
	if x != nil {
		return x.WaitUntil
	}
	return nil
...
func (x *StartPageRequest) GetNameSuffix() string {
	if x != nil {
		return x.NameSuffix
	}
	return ""
...
type StartFromPreviousPageRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PreviousPage string                 `protobuf:"bytes,1,opt,name=previous_page,json=previousPage,proto3" json:"previous_page,omitempty"`
...
func (x *StartFromPreviousPageRequest) Reset() {
	*x = StartFromPreviousPageRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *StartFromPreviousPageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartFromPreviousPageRequest) ProtoMessage() {}

func (x *StartFromPreviousPageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cms_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartFromPreviousPageRequest.ProtoReflect.Descriptor instead.
func (*StartFromPreviousPageRequest) Descriptor() ([]byte, []int) {
	return file_cms_proto_rawDescGZIP(), []int{3}
}

func (x *StartFromPreviousPageRequest) GetPreviousPage() string {
	if x != nil {
...
func (x *StartFromPreviousPageRequest) GetGitopsToken() string {
	if x != nil {
...
func (x *StartFromPreviousPageRequest) GetWaitUntil() *timestamppb.Timestamp {
	if x != nil {
		return x.WaitUntil
	}
	return nil
...
func (x *ListPagesRequest) GetFilter() []*FilterExpression {
	if x != nil {
		return x.Filter
	}
	return nil
...
func (x *ListPagesRequest) GetOrder() []*OrderExpression {
	if x != nil {
		return x.Order
	}
	return nil
...
func (x *ListPagesRequest) GetStart() int32 {
	if x != nil {
		return x.Start
	}
	return 0
...
type ListPagesResponse struct {
	...
	Result []*PageStatus `protobuf:"bytes,2,rep,name=result,proto3" json:"result,omitempty"`
}
...
func (x *ListPagesResponse) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *ListPagesResponse) GetResult() []*PageStatus {
	if x != nil {
		return x.Result
	}
	return nil
...
type SubscribeResponse struct {
	...
	Result *PageStatus `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"`
}
...
func (x *SubscribeResponse) GetResult() *PageStatus {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *GetPageResponse) GetResult() *PageStatus {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *ListenResponse) GetUpdate() *PageStatus {
...
type ListenResponse_Update struct {
	Update *PageStatus `protobuf:"bytes,1,opt,name=update,proto3,oneof"`
}
...
type PageStatus struct {
	...
	Phase      PagePhase       `protobuf:"varint,3,opt,name=phase,proto3,enum=v1.PagePhase" json:"phase,omitempty"`
	Conditions *PageConditions `protobuf:"bytes,4,opt,name=conditions,proto3" json:"conditions,omitempty"`
	Details    string          `protobuf:"bytes,5,opt,name=details,proto3" json:"details,omitempty"`
	Results    []*PageResult   `protobuf:"bytes,6,rep,name=results,proto3" json:"results,omitempty"`
}

func (x *PageStatus) Reset() {
	*x = PageStatus{}
	if protoimpl.UnsafeEnabled {
...
func (*PageStatus) ProtoMessage() {}

func (x *PageStatus) ProtoReflect() protoreflect.Message {
	mi := &file_cms_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PageStatus.ProtoReflect.Descriptor instead.
func (*PageStatus) Descriptor() ([]byte, []int) {
	return file_cms_proto_rawDescGZIP(), []int{15}
}

func (x *PageStatus) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PageStatus) GetMetadata() *PageMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *PageStatus) GetPhase() PagePhase {
	if x != nil {
		return x.Phase
	}
	return PagePhase_PHASE_UNKNOWN
}

func (x *PageStatus) GetConditions() *PageConditions {
	if x != nil {
		return x.Conditions
	}
	return nil
...
func (x *PageStatus) GetDetails() string {
	if x != nil {
		return x.Details
	}
	return ""
...
func (x *PageStatus) GetResults() []*PageResult {
	if x != nil {
		return x.Results
	}
	return nil
...
type PageMetadata struct {
	...
	Trigger      PageTrigger            `protobuf:"varint,3,opt,name=trigger,proto3,enum=v1.PageTrigger" json:"trigger,omitempty"`
	...
	PageSpecName string                 `protobuf:"bytes,7,opt,name=page_spec_name,json=pageSpecName,proto3" json:"page_spec_name,omitempty"`
}
...
func (x *PageMetadata) GetOwner() string {
	if x != nil {
		return x.Owner
	}
	return ""
...
func (x *PageMetadata) GetRepository() *Repository {
	if x != nil {
		return x.Repository
	}
	return nil
...
func (x *PageMetadata) GetTrigger() PageTrigger {
	if x != nil {
		return x.Trigger
	}
	return PageTrigger_TRIGGER_UNKNOWN
}

func (x *PageMetadata) GetCreated() *timestamppb.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *PageMetadata) GetFinished() *timestamppb.Timestamp {
	if x != nil {
		return x.Finished
	}
	return nil
...
func (x *PageMetadata) GetAnnotations() []*Annotation {
	if x != nil {
...
func (x *PageMetadata) GetPageSpecName() string {
	if x != nil {
		return x.PageSpecName
	}
	return ""
}
...
func (x *PageConditions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PageConditions) ProtoMessage() {}

func (x *PageConditions) ProtoReflect() protoreflect.Message {
	mi := &file_cms_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PageConditions.ProtoReflect.Descriptor instead.
func (*PageConditions) Descriptor() ([]byte, []int) {
	return file_cms_proto_rawDescGZIP(), []int{19}
}

func (x *PageConditions) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *PageConditions) GetFailureCount() int32 {
	if x != nil {
...
func (x *PageConditions) GetCanReplay() bool {
	if x != nil {
		return x.CanReplay
	}
	return false
...
func (x *PageConditions) GetWaitUntil() *timestamppb.Timestamp {
	if x != nil {
		return x.WaitUntil
	}
	return nil
...
func (x *PageConditions) GetDidExecute() bool {
	if x != nil {
		return x.DidExecute
	}
	return false
...
func (x *PageResult) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *PageResult) GetPayload() string {
	if x != nil {
		return x.Payload
	}
	return ""
...
func (x *PageResult) GetDescription() string {
	if x != nil {
...
func (x *PageResult) GetChannels() []string {
	if x != nil {
		return x.Channels
	}
	return nil
...
func (x *StopPageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StopPageRequest) ProtoMessage() {}

func (x *StopPageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cms_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StopPageRequest.ProtoReflect.Descriptor instead.
func (*StopPageRequest) Descriptor() ([]byte, []int) {
	return file_cms_proto_rawDescGZIP(), []int{22}
}

func (x *StopPageRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type StopPageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *StopPageResponse) Reset() {
	*x = StopPageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *StopPageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StopPageResponse) ProtoMessage() {}

func (x *StopPageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cms_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StopPageResponse.ProtoReflect.Descriptor instead.
func (*StopPageResponse) Descriptor() ([]byte, []int) {
...
var file_cms_proto_rawDesc = []byte{
	0x0a, 0x09, 0x63, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x31, 0x1a,
	0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x22, 0xf3, 0x01, 0x0a, 0x15, 0x53, 0x74, 0x61, 0x72, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x50,
	0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x08, 0x6d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x76,
	0x31, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x48, 0x00,
	...
	0x09, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x79, 0x61, 0x6d, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c,
	0x48, 0x00, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x59, 0x61, 0x6d, 0x6c, 0x12, 0x29, 0x0a, 0x0f,
	...
	0x2e, 0x50, 0x61, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x22, 0xf2, 0x01, 0x0a, 0x10, 0x53, 0x74, 0x61, 0x72, 0x74, 0x50, 0x61, 0x67,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x70,
	0x61, 0x74, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x50,
	0x61, 0x74, 0x68, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x79, 0x61, 0x6d, 0x6c,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x59, 0x61, 0x6d, 0x6c,
	...
	0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x72, 0x65,
	0x76, 0x69, 0x6f, 0x75, 0x73, 0x5f, 0x70, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0c, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x50, 0x61, 0x67, 0x65, 0x12, 0x21,
	...
	0x6e, 0x64, 0x69, 0x6e, 0x67, 0x22, 0x51, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x61, 0x67,
	...
	0x32, 0x0e, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x0e, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x24, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x50, 0x61,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x53, 0x74,
	...
	0x74, 0x65, 0x6e, 0x74, 0x22, 0xeb, 0x01, 0x0a, 0x0a, 0x50, 0x61, 0x67, 0x65, 0x53, 0x74, 0x61,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x50, 0x68,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f,
	...
	0x74, 0x73, 0x22, 0xc5, 0x02, 0x0a, 0x0c, 0x50, 0x61, 0x67, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64,
	...
	0x50, 0x61, 0x67, 0x65, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x52, 0x07, 0x74, 0x72, 0x69,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x12, 0x24, 0x0a, 0x0e, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x70, 0x65,
	0x63, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x70, 0x61,
	0x67, 0x65, 0x53, 0x70, 0x65, 0x63, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x78, 0x0a, 0x0a, 0x52, 0x65,
	...
	0x61, 0x67, 0x65, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x18, 0x0a,
	...
	0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x22, 0x78, 0x0a, 0x0a, 0x50, 0x61, 0x67, 0x65, 0x52,
	...
	0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x25, 0x0a, 0x0f, 0x53, 0x74, 0x6f, 0x70, 0x50, 0x61,
	0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x12, 0x0a,
	0x10, 0x53, 0x74, 0x6f, 0x70, 0x50, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x4f, 0x47, 0x53, 0x5f, 0x48, 0x54, 0x4d, 0x4c, 0x10, 0x03, 0x2a, 0x5d, 0x0a, 0x0b, 0x50, 0x61,
	0x67, 0x65, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x12, 0x13, 0x0a, 0x0f, 0x54, 0x52, 0x49,
	...
	0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x90, 0x01, 0x0a, 0x09, 0x50, 0x61,
	0x67, 0x65, 0x50, 0x68, 0x61, 0x73, 0x65, 0x12, 0x11, 0x0a, 0x0d, 0x50, 0x48, 0x41, 0x53, 0x45,
	...
	,
	...
	0x74, 0x50, 0x61, 0x67, 0x65, 0x12, 0x12, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x61,
	0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x76, 0x31, 0x2e, 0x47,
	...
	0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x37, 0x0a, 0x08, 0x53, 0x74, 0x6f, 0x70, 0x50, 0x61, 0x67,
	0x65, 0x12, 0x13, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x74, 0x6f, 0x70, 0x50, 0x61, 0x67, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x74, 0x6f, 0x70,
	0x50, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x23,
	0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x68, 0x6f,
	0x6a, 0x70, 0x75, 0x72, 0x2f, 0x63, 0x6d, 0x73, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69,
...
var file_cms_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_cms_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_cms_proto_goTypes = []interface{}{
	(FilterOp)(0),                        // 0: v1.FilterOp
	(ListenRequestLogs)(0),               // 1: v1.ListenRequestLogs
	(PageTrigger)(0),                     // 2: v1.PageTrigger
	(PagePhase)(0),                       // 3: v1.PagePhase
	(LogSliceType)(0),                    // 4: v1.LogSliceType
	(*StartLocalPageRequest)(nil),        // 5: v1.StartLocalPageRequest
	(*StartPageResponse)(nil),            // 6: v1.StartPageResponse
	(*StartPageRequest)(nil),             // 7: v1.StartPageRequest
	(*StartFromPreviousPageRequest)(nil), // 8: v1.StartFromPreviousPageRequest
	(*ListPagesRequest)(nil),             // 9: v1.ListPagesRequest
	(*FilterExpression)(nil),             // 10: v1.FilterExpression
	(*FilterTerm)(nil),                   // 11: v1.FilterTerm
	(*OrderExpression)(nil),              // 12: v1.OrderExpression
	(*ListPagesResponse)(nil),            // 13: v1.ListPagesResponse
	(*SubscribeRequest)(nil),             // 14: v1.SubscribeRequest
	(*SubscribeResponse)(nil),            // 15: v1.SubscribeResponse
	(*GetPageRequest)(nil),               // 16: v1.GetPageRequest
	(*GetPageResponse)(nil),              // 17: v1.GetPageResponse
	(*ListenRequest)(nil),                // 18: v1.ListenRequest
	(*ListenResponse)(nil),               // 19: v1.ListenResponse
	(*PageStatus)(nil),                   // 20: v1.PageStatus
	(*PageMetadata)(nil),                 // 21: v1.PageMetadata
	(*Repository)(nil),                   // 22: v1.Repository
	(*Annotation)(nil),                   // 23: v1.Annotation
	(*PageConditions)(nil),               // 24: v1.PageConditions
	(*PageResult)(nil),                   // 25: v1.PageResult
	(*LogSliceEvent)(nil),                // 26: v1.LogSliceEvent
	(*StopPageRequest)(nil),              // 27: v1.StopPageRequest
	(*StopPageResponse)(nil),             // 28: v1.StopPageResponse
	(*timestamppb.Timestamp)(nil),        // 29: google.protobuf.Timestamp
}
var file_cms_proto_depIdxs = []int32{
	21, // 0: v1.StartLocalPageRequest.metadata:type_name -> v1.PageMetadata
	20, // 1: v1.StartPageResponse.status:type_name -> v1.PageStatus
	21, // 2: v1.StartPageRequest.metadata:type_name -> v1.PageMetadata
	29, // 3: v1.StartPageRequest.wait_until:type_name -> google.protobuf.Timestamp
	29, // 4: v1.StartFromPreviousPageRequest.wait_until:type_name -> google.protobuf.Timestamp
	10, // 5: v1.ListPagesRequest.filter:type_name -> v1.FilterExpression
	12, // 6: v1.ListPagesRequest.order:type_name -> v1.OrderExpression
	11, // 7: v1.FilterExpression.terms:type_name -> v1.FilterTerm
	0,  // 8: v1.FilterTerm.operation:type_name -> v1.FilterOp
	20, // 9: v1.ListPagesResponse.result:type_name -> v1.PageStatus
	10, // 10: v1.SubscribeRequest.filter:type_name -> v1.FilterExpression
	20, // 11: v1.SubscribeResponse.result:type_name -> v1.PageStatus
	20, // 12: v1.GetPageResponse.result:type_name -> v1.PageStatus
	1,  // 13: v1.ListenRequest.logs:type_name -> v1.ListenRequestLogs
	20, // 14: v1.ListenResponse.update:type_name -> v1.PageStatus
	26, // 15: v1.ListenResponse.slice:type_name -> v1.LogSliceEvent
	21, // 16: v1.PageStatus.metadata:type_name -> v1.PageMetadata
	3,  // 17: v1.PageStatus.phase:type_name -> v1.PagePhase
	24, // 18: v1.PageStatus.conditions:type_name -> v1.PageConditions
	25, // 19: v1.PageStatus.results:type_name -> v1.PageResult
	22, // 20: v1.PageMetadata.repository:type_name -> v1.Repository
	2,  // 21: v1.PageMetadata.trigger:type_name -> v1.PageTrigger
	29, // 22: v1.PageMetadata.created:type_name -> google.protobuf.Timestamp
	29, // 23: v1.PageMetadata.finished:type_name -> google.protobuf.Timestamp
	23, // 24: v1.PageMetadata.annotations:type_name -> v1.Annotation
	29, // 25: v1.PageConditions.wait_until:type_name -> google.protobuf.Timestamp
	4,  // 26: v1.LogSliceEvent.type:type_name -> v1.LogSliceType
	5,  // 27: v1.CmsService.StartLocalPage:input_type -> v1.StartLocalPageRequest
	8,  // 28: v1.CmsService.StartFromPreviousPage:input_type -> v1.StartFromPreviousPageRequest
	7,  // 29: v1.CmsService.StartPage:input_type -> v1.StartPageRequest
	9,  // 30: v1.CmsService.ListPages:input_type -> v1.ListPagesRequest
	14, // 31: v1.CmsService.Subscribe:input_type -> v1.SubscribeRequest
	16, // 32: v1.CmsService.GetPage:input_type -> v1.GetPageRequest
	18, // 33: v1.CmsService.Listen:input_type -> v1.ListenRequest
	27, // 34: v1.CmsService.StopPage:input_type -> v1.StopPageRequest
	6,  // 35: v1.CmsService.StartLocalPage:output_type -> v1.StartPageResponse
	6,  // 36: v1.CmsService.StartFromPreviousPage:output_type -> v1.StartPageResponse
	6,  // 37: v1.CmsService.StartPage:output_type -> v1.StartPageResponse
	13, // 38: v1.CmsService.ListPages:output_type -> v1.ListPagesResponse
	15, // 39: v1.CmsService.Subscribe:output_type -> v1.SubscribeResponse
	17, // 40: v1.CmsService.GetPage:output_type -> v1.GetPageResponse
	19, // 41: v1.CmsService.Listen:output_type -> v1.ListenResponse
	28, // 42: v1.CmsService.StopPage:output_type -> v1.StopPageResponse
...
func file_cms_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cms_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StartLocalPageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cms_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StartPageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cms_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StartFromPreviousPageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_cms_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*StartLocalPageRequest_Metadata)(nil),
		(*StartLocalPageRequest_ConfigYaml)(nil),
		(*StartLocalPageRequest_PageYaml)(nil),
		(*StartLocalPageRequest_ApplicationTar)(nil),
		(*StartLocalPageRequest_ApplicationTarDone)(nil),
	}
	file_cms_proto_msgTypes[14].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_cms_proto_enumTypes,
