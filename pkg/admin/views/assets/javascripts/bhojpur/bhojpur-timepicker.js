(function(factory) {
    ...
    var NAMESPACE = 'bhojpur.timepicker';
    ...
    function BhojpurTimepicker(element, options) {
        this.$element = $(element);
        this.options = $.extend(true, {}, BhojpurTimepicker.DEFAULTS, $.isPlainObject(options) && options);
    ...
    BhojpurTimepicker.prototype = {
        ...
        bind: function() {
            ...
            if (this.isDateTimePicker) {
                this.$targetInput
                    .bhojpurTimepicker(pickerOptions)
        ...
        show: function() {
            ...
            this.$targetInput.bhojpurTimepicker('show');
            this.oldValue = this.$targetInput.val();
        },

        destroy: function() {
            this.unbind();
            this.$targetInput.bhojpurTimepicker('remove');
            this.$element.removeData(NAMESPACE);
        }
    };

    BhojpurTimepicker.DEFAULTS = {};

    BhojpurTimepicker.plugin = function(option) {
        return this.each(function() {
            ...
            if (!data) {
                ...
                $this.data(NAMESPACE, (data = new BhojpurTimepicker(this, options)));
            }
    ...
    $(function() {
        var selector = '[data-toggle="bhojpur.timepicker"]';

        $(document)
            .on(EVENT_DISABLE, function(e) {
                BhojpurTimepicker.plugin.call($(selector, e.target), 'destroy');
            })
            .on(EVENT_ENABLE, function(e) {
                BhojpurTimepicker.plugin.call($(selector, e.target));
            })
            .triggerHandler(EVENT_ENABLE);
    });

    return BhojpurTimepicker;
});